...
const addressList = [
    ...
    },
    {
        ...
        text: '+222 123 456 789',
    },
    {
        iconName: 'icofont-envelope',
        text: 'info@easyshop.com',
    },
]
...
const tweetList = [
    {
        iconName: 'icofont-twitter',
        desc: <p>Richie <a href="#"> @EasyShop Greetings! </a> Grab your item, 50% Big Sale Offer !!</p>,
    },
    {
        iconName: 'icofont-twitter',
        desc: <p>Richie <a href="#"> @EasyShop Hey! </a> Grab your item, 50% Big Sale Offer !!</p>,
    },
]
    ...
    <div className="footer-bottom">
        <div className="container">
            <div className="section-wrapper">
                <p>&copy; 2023 <Link to="/">Easy Shop</Link> Designed by <a href="#" target="_blank">Richie</a> </p>
